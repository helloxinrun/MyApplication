...
public class RePluginActivity extends Activity {
  // 外置插件相关
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_replugin);
    findViewById(R.id.btn_start_demo1).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        // 刻意以“包名”来打开
        RePlugin.startActivity(RePluginActivity.this,
    ...
    findViewById(R.id.btn_start_plugin_for_result).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        intent.setComponent(new ComponentName("demo1",
            "com.qihoo360.replugin.sample.demo1.activity.for_result.ForResultActivity"));
        RePlugin.startActivityForResult(RePluginActivity.this, intent, REQUEST_CODE_DEMO1, null);
      }
    });
    ...
    findViewById(R.id.btn_load_fragment_from_demo1).setOnClickListener(new View.OnClickListener() {
      ...
      @Override
      public void onClick(View v) {
        startActivity(new Intent(RePluginActivity.this, RePluginFragmentActivity.class));
      }
    });
    ...
    findViewById(R.id.btn_install_apk_from_assets).setOnClickListener(new View.OnClickListener() {
      ...
      @Override
      public void onClick(View v) {
        final ProgressDialog pd = ProgressDialog.show(RePluginActivity.this, "Installing...",
  ...
  /**
   * 模拟安装外置插件 注意：为方便演示，外置插件临时放置到Host的assets/external目录下，具体说明见README
   * </p>
   *
   * @param pluginName
   *          待安装的插件名
  ...
  private void simulateInstallExternalPlugin(String pluginName) {
    ...
    if (info != null) {
      RePlugin.startActivity(RePluginActivity.this,
          RePlugin.createIntent(info.getName(), "com.qihoo360.replugin.sample.demo3.MainActivity"));
    } else {
      Toast.makeText(RePluginActivity.this, "install external plugin failed", Toast.LENGTH_SHORT)
          .show();
    }
  }
