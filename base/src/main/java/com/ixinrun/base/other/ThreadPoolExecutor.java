package com.ixinrun.base.other;
...
public class ThreadPoolExecutor {
     ...
     */
    public ThreadPoolExecutor(Type type, int corePoolSize) {
        switch (type) {
            case FixedThread:
                // 构造一个固定线程数目的线程池
    ...
    public ScheduledFuture<?> scheduleWithFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
        return ((ScheduledExecutorService) exec).scheduleAtFixedRate(command, initialDelay, period, unit);
    }
    ...
    public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
        return ((ScheduledExecutorService) exec).scheduleWithFixedDelay(command, initialDelay, delay, unit);
    }
}
